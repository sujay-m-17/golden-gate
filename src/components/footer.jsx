...
import accreditationImage from '../assets/accreditation.png'
...
export function FooterWithSocialLinks() {
    return (
        <footer className="relative w-full">
            <div className="mx-auto w-full max-w-[1600px] px-8 pt-[70px]">
                <div className="grid grid-cols-1 justify-between gap-4 md:grid-cols-2">
                    <div className="contact_information">
                        <div className="footer__image max-w-[250px]">
                    ...
                    <div className="grid grid-cols-2 justify-between gap-4">
                        ...
                        <div className="accreditation flex flex-col items-center">
                            <Typography
                                variant="small"
                                color="blue-gray"
                                className="mb-3 text-[20px] font-button font-bold"
                            ...
                            <img src={accreditationImage} alt="Accreditation Image" />
                        </div>
                    </div>
                </div>
                <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-blue-gray-50 py-4 md:flex-row md:justify-between">
                    <Typography
                        variant="small"
                        className="mb-4 text-center font-button font-normal text-blue-gray-900 md:mb-0"
                    >
                        &copy; {currentYear} <a href="#">Golden Gate Dairy Products Manufacturing L.L.C</a>. All
                        Rights Reserved.
                    </Typography>
